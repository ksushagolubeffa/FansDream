...
public class UserServiceBase implements UserService {
    ...
    @Override
    public boolean saveUser(String username, String email, String password) throws IOException {
    ...
    @Override
    public void updateUser(Principal principal, String username, String password, MultipartFile imageFile) throws IOException{
